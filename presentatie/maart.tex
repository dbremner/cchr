...
\frame{\frametitle{Resultaten}
  ...
  \hline
  {\bf gcd}   & 37.1s & -     & 0.085s  & 0.085s  & 0.019s \\
  {\bf fib}   &  708s & 5.0s  & 0.024s  & 1.3s    & 0.003s \\
  {\bf primes}& 4.12s & 4.3s  & 0.091s  & 0.091s  & 0.010s \\
  {\bf tak}   & 6.19s & 0.57s & 0.048s  & 21s     & 0.007s \\
  {\bf ram}   & 0.63s & 0.62s & 0.016s  & 0.0057s & 0.0001s \\
  {\bf merge} & 0.33s & 1.6s  & 0.036s  & 0.019s  & 0.0005s \\
  {\bf leq}   & 947s  & 2.8s  & 0.0008s & 1.3s    & 0.0008s \\
  \hline
  {\bf avg} & 650 & 95 & 1 & 14 & 0.075 \\
  \end{tabular}
  \end{block}
}
