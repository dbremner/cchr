...
\frame{\frametitle{Resultaten}
  ...
  \hline
  {\bf gcd}   & 37.1s & -     & 0.084s & 0.084s & 0.019s \\
  {\bf fib}   &  708s & 5.0s  & 0.023s & 1.2s   & 0.003s \\
  {\bf primes}& 4.12s & 4.3s  & 0.090s & 0.090s & 0.010s \\
  {\bf tak}   & 6.19s & 0.57s & 0.048s & 17.6s  & 0.007s \\
  {\bf ram}   & 0.63s & 0.62s & 0.016s & 0.005s & 0.0001s \\
  {\bf merge} & 0.33s & 1.6s  & 0.035s & 0.016s & 0.0005s \\
  {\bf leq}   & 947s  & 2.8s  & 0.006s & 1.09s  & 0.0038s \\
  \hline
  {\bf avg} & 469 & 68 & 1 & 8.9 & 0.07 \\
  \end{tabular}
  \end{block}
}
