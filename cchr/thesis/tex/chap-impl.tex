...
In de komende tekst zal vaak verwezen worden naar macro's, sommigen daarvan staan in het macro-definitie bestand, anderen worden door de compiler gegenereerd. Gegenereerde macros zullen daarom ook steeds ``gegenereerde macros'' genoemd worden, om verwarring te vermijden.
...
\item Aantal kept/removed constraints in elke CHR regel (\code{RULE\_KEPT\_\argu{rule}}).
\item Wat en waarin in propagation geschiedenis bij te houden (\code{PROPHIST\_\argu{rule}} en \code{PROPHIST\_HOOK\_\argu{rule}}).
