...
Dit zal het mogelijk maken om 2 \code{bigint\_t} variabelen met elkaar te vergelijken mbv. \code{eqv(a,b)}, maar ook 2 andere variabelen met behulp van de C operator \code{==}. Het datatype \code{bigint\_t} zou elders gedefinieerd moeten zijn.
...
Pointers zijn 1 mogelijkheid om een constraint argument met vaste waarde toch van ``betekenis'' te doen veranderen. In CCHR zou bovenstaand voorbeeld opgelost kunnen als volgt: \begin{Verbatim}
