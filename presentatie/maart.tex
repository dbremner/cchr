...
\cBlue{dec @} fib(N2,F1) \cBlue{\bs} fib(N1,F2) \cBlue{<=>}
  alt(N1+1==N2,N1==N2-1) \cBlue{|} fib(N2+1,F1+F2)\cBlue{;}
  \end{Verbatim}
  \end{example}
}
...
\frame{\frametitle{Resultaten}
  ...
  \hline
  gcd & 37.1s & - & 0.084s & 0.084s & 0.019s \\
  fib & 708s & 5.0s & 0.023s & 1.2s & 0.003s \\
  primes & 4.12s & 4.3s & 0.090s & 0.090s & 0.0007s \\
  tak & 6.19s & 0.57s & 0.048s & 17.6s & 0.007s \\
  ram & 0.63s & 0.62s & 0.016s & 0.005s & 0.0001s \\
  merge & 0.33s & 1.6s & 0.035s & 0.016s & 0.0005s \\
  leq & 947s & 2.8s & 1.09s & 1.09s & 0.0038s  \\
  \hline
  avg & 197 & 29 & 1 & 3.7 & 0.019 \\
  \end{tabular}
  \end{block}
}
