...
\begin{enumerate}
  ...
  \item De body van de CHR rule wordt uitgevoerd, met de verwijzingen naar lokale variabelen vervangen door \code{CSM\_LOCAL}-macro's en de constraint argumenten door \code{CSM\_ARG} en \code{CSM\_LARG}.
