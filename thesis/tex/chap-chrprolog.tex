...
Typerend voor het K.U.Leuven CHR systeem is de grote hoeveelheid analyses en optimalisaties die uitgevoerd worden. In \cite{tomsphdthesis} wordt het compilatieschema uitgelegd, waar ook dat van CCHR op gebaseerd is (zie sectie~\ref{sec:gencode}). Daarna worden stap voor stap optimalisaties toegevoegd en verantwoord.

\subsection{Compilatieschema}

De CHR-Prolog compiler vertaalt de CHR regels
